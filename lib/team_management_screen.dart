      ...
      for (final item in participantsResponse) {
        if (item['profiles'] != null) {
          final participant = {
            ...
            'nombre': item['profiles']['nombre'] ?? 'Usuario',
    ...
    try {
      ...
      setState(() {
        ...
        if (participant['equipo'] == 'claro') {
          _teamClaro.removeWhere((p) => p['id'] == participant['id']);
        } else if (participant['equipo'] == 'oscuro') {
          _teamOscuro.removeWhere((p) => p['id'] == participant['id']);
        } else {
          _unassignedParticipants.removeWhere((p) => p['id'] == participant['id']);
        }
